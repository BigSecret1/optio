...
class Project(models.Model):
    ...
    project_updated = models.DateTimeField(
        auto_now=True)  # Maps to CURRENT_TIMESTAMP with timezone
    ...
    class Meta:
        db_table = "projects"
        indexes = [
            models.Index(fields=["id"], name="projects_pkey"),
            # Matches the primary key index
        ]
        constraints = [
