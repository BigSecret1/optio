...
SECRET_KEY = 'django-insecure-j755-53t36iqmy1u283w+^-1=y&o00y@43l(+67s(4z&k&blg3'
...
WSGI_APPLICATION = 'optioconf.wsgi.application'
...
LOGGING = {
    ...
    'root': {
        'handlers': ['console'],
        'level': 'DEBUG',  # Root level logs
    },
    'loggers': {
        'django': {
            'handlers': ['console'],
            'level': 'WARNING',  # Change to INFO or DEBUG if needed
            'propagate': True,
        },
        '__main__': {
            'handlers': ['console'],
